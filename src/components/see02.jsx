...
const See02 = ({picture,bigWord,littleWord}) => {
    ...
    return <div className="work03-see">
        ...
        <div className="row-column">
            <div className="row-picture" style={{backgroundImage:`url(${picture})`}}></div>
            ...
            <div className="row-column" style={{marginLeft:"20vw"}}>
